...
<body>
    <div id="top_bg">
        <div class="main_title" align="center">
            <img src="img/icon.png">Transfer Dashboard
        </div>
    </div>

    <div id="bottom_bg">
        <div class="main_footer" align="center">
            <a href="http://capablebits.com" target="_blank">©&nbsp;Copyright&nbsp;2013.&nbsp;Capable&nbsp;Bits.&nbsp;All&nbsp;rights&nbsp;reserved</a><br>
            <br>
        ...
        <div id="main_block" class="main_block">
            ...
            <div id="device_block" class="info_block">
                ...
                <div class="action_block" id="download_block" align="center">
                    <img id="download_img" src="img/img_download.png" alt="img_download" width="" height="">
                ...
                <div class="action_block" id="upload_block" align="center">
                    <img src="img/img_upload.png" alt="img_upload" width="" height="">
