...
@property (readonly,assign) const struct pbmg_request_info *requestInfo;
 ...
 */
- (id)initWithRequestInfo:(const struct pbmg_request_info *)ri body:(NSData *)bd;
